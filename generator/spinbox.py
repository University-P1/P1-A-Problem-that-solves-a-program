...
# Stolen from `https://customtkinter.tomschimansky.com/tutorial/spinbox/`
# and slightly modified to remove warnings and errors
@final
class Spinbox(tk.CTkFrame):
    def __init__(self, *args,
        ...
        _ =self.grid_columnconfigure((0, 2), weight=0)  # buttons don't expand
        _ =self.grid_columnconfigure(1, weight=1)  # entry expands
